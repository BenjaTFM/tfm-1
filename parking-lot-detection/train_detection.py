...
from tensorflow.keras.layers import Flatten, Dense, Conv2D, MaxPooling2D, Activation, Dropout, Input
    ...
    for day in train_days:
        ...
        for i, label in enumerate(labels):
            ...
            for j,img_name in enumerate(img_names):
                ...
                img = imageio.imread(img_root + img_name)
